        ...
        <div class="row">
            <div class="col-12">
                <div class="app-entry-form-section" id="basic">
                    <div class="section-title">{!! trans('setting.names') !!}</div>
                    <div class='row'>
                        <div class='col-md-12 col-sm-12'>
                            <div class='row'>
                                <div class='col-md-12 col-sm-12'>
                                    <fieldset>
                                        <legend>{{trans('setting.label.theme.admin.name')}}</legend>
                                        <div class="row">

                                            <div class="col-md-4">
                                                {!! Form::select('settings[main.admin.color]')
                                                -> label(trans('setting.label.theme.admin.color'))
                                                -> options(__('settings::setting.options.theme'),
                                                setting('main.admin.color'))!!}
                                            </div>
                                            <div class="col-md-4">
                                                {!! Form::file('upload[theme.admin.logo.logo][file]')
                                                -> label(trans('setting.label.theme.admin.logo.logo'))
                                                ->
                                                placeholder(trans('setting.placeholder.theme.admin.logo.logo'))!!}
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                -> label(trans('setting.label.theme.admin.logo.white'))
                                                ->
                                                placeholder(trans('setting.placeholder.theme.admin.logo.white'))!!}
                                    ...
                                    <fieldset>
                                        <legend>{{trans('setting.label.theme.user.name')}}</legend>
                                        <div class="row">
                                            <div class="col-md-4">
                                                {!! Form::select('settings[main.user.color]')
                                                -> label(trans('setting.label.theme.user.color'))
                                                -> options(__('settings::setting.options.theme'),
                                                setting('main.user.color'))!!}
                                            </div>
                                            <div class="col-md-4">
                                                {!! Form::file('upload[theme.user.logo.logo][file]')
                                                -> label(trans('setting.label.theme.user.logo.logo'))
                                                ->
                                                placeholder(trans('setting.placeholder.theme.user.logo.logo'))!!}
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                -> label(trans('setting.label.theme.user.logo.white'))
                                                ->
                                                placeholder(trans('setting.placeholder.theme.user.logo.white'))!!}
                                    ...
                                    <fieldset>
                                        <legend>{{trans('setting.label.theme.public.name')}}</legend>
                                        <div class="row">

                                            <div class="col-md-4">
                                                {!! Form::select('settings[main.public.color]')
                                                -> label(trans('setting.label.theme.public.color'))
                                                -> options(__('settings::setting.options.theme'),
                                                setting('main.public.color'))!!}
                                            </div>
                                            <div class="col-md-4">
                                                {!! Form::file('upload[theme.public.logo.logo][file]')
                                                -> label(trans('setting.label.theme.public.logo.logo'))
                                                ->
                                                placeholder(trans('setting.placeholder.theme.public.logo.logo'))!!}
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                -> label(trans('setting.label.theme.public.logo.white'))
                                                ->
                                                placeholder(trans('setting.placeholder.theme.public.logo.white'))!!}
