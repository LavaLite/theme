...
<div class="app-entry-form-wrap">
        ...
        <div class="actions">
            <div class="action-buttons">
                <button type="button" class="btn btn-with-icon btn-link" data-action='EDIT' data-load-to="#app-entry"
                    data-url="{!!guard_url('masters/master')!!}/{!!$data['id']!!}/edit"><i
                ...
                <button type="button" class="btn btn-with-icon btn-link" data-action='DELETE' data-load-to="#app-entry"
                    data-list="#item-list" data-url="{!!guard_url('masters/master')!!}/{!!$data['id']!!}"><i
    ...
    ->class('app-form-show')
    ->method('PUT')
    ->action(guard_url('masters/master'. $data['id']))!!}

    @include('litepie.master.entry', ['mode' => 'show'])
