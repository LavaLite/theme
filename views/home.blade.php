        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-lg-1">
                <div class="hero-content">
                    <h1>Redesigned, how you build landing page!</h1>
                    <p>Create custom landing pages with Lavalite that convert more visitors than any website. With lots of unique blocks, you can easily build a page without coding.</p>
                    <div class="hero-btn">
                        <a href="login.html" class="btn btn-theme">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
