        ...
        <div class="row">
            <div class="col-12">
                <div class="app-entry-form-section" id="basic">
                    <div class="section-title">{{trans('setting.title.sms')}} {!! trans('setting.name') !!}</div>
                    <div class='row'>
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                -> label(trans('setting.label.sms.url'))
                                                -> value(setting('main.sms.url'))
                                                -> placeholder(trans('setting.placeholder.sms.url'))!!}
                                            </div>
                                            <div class="col-md-6">
                                                {!! Form::text('settings[main.sms.code]')
                                                -> label(trans('setting.label.sms.code'))
                                                -> value(setting('main.sms.code'))
                                                -> placeholder(trans('setting.placeholder.sms.code'))!!}
                                            </div>
                                            <div class="col-md-6">
                                                {!! Form::text('settings[main.sms.secret]')
                                                -> label(trans('setting.label.sms.secret'))
                                                -> value(setting('main.sms.secret'))
                                                -> placeholder(trans('setting.placeholder.sms.secret'))!!}
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
